...
namespace Microsoft.Extensions.DependencyInjection
{
    public class ApplicationModelConventionExtensionsTest
    {
        ...
        [Fact]
        public void DefaultPropertyModelConvention_AppliesToAllControllerProperties()
        {
            // Arrange
            var app = new ApplicationModel();
            var controllerType1 = typeof(HelloController).GetTypeInfo();
        ...
        public void ApplicationModelConventions_CopiesPropertyModelCollectionOnApply()
        {
            ...
            var propertyModelConvention = new PropertyModelCollectionModifyingConvention();
            var conventions = new List<IApplicationModelConvention>();
        ...
        private class SimplePropertyConvention : IPropertyModelConvention
        {
            public void Apply(PropertyModel action)
            {
                action.Properties.Add("TestProperty", "TestValue");
            }
        }
        ...
        private class PropertyModelCollectionModifyingConvention : IPropertyModelConvention
        {
            public void Apply(PropertyModel property)
            {
